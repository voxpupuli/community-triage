...
### Discussion:
* splunk lacks all forms of testing, it would be great to get some basic acceptance testing laid down. Lets do that for this triage!
* splunk needs a new release for certain new features. tragiccode added the ability to manage ui-prefs.conf

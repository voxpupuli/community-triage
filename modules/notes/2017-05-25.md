...
Requesting postgresql PR triage on 2017-05-24
16:46    dhollinger | Hunner: if there is time: https://github.com/puppetlabs/puppetlabs-lvm/pull/187

### Discussion:
* aligning params on $ and = or not
* anti-data-in-modules rant from Hunner

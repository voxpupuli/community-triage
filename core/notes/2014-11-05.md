...
At the start of the triage Puppet had 60 open PRs Facter had 4 open PRs, and Hiera had 1 open PR.
...
[3107](https://github.com/puppetlabs/puppet/pull/3107) - [PUP-3319](https://tickets.puppetlabs.com/browse/PUP-3319) - Retry send report if connection to master fails
  ...
  - 10/29 - NO REVIEW
  - 11/05 - blocked, retryaction still hasn't been added back

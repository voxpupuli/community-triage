...
Britt Gresham (demophoon), Daniele Sluijters (daenney), Eric Thompson (er0ck), Felix Frank (ffrank), Henrik Lindberg (hlindberg), Jeff Palmer (palmerit), Josh Cooper (joshcooper), Kylo Ginsber (kylog), Leonardo Mello (lmello), Rob Reynolds (ferventcoder), Will Hopper (whopper)

### Summary

At the start of the triage Puppet had 58 open PRs, Facter had 5 open PRs, and Hiera had 1 open PRs.
